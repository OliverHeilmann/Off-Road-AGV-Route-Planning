...
START = (84,225)  			# index value which agent starts at after including corner size (row, col)
END   = (143,220)	        # index value which agent ends at after including corner size, set to None for ending at top, right corner (row, col)
