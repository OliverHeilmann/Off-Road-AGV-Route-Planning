...
class LandTypes:
    ...
    def __init__( self, ):
        ...
        self.classes = {
            "Firebreak" : [ [0, 0, 0]      , [0, 0, 0]      , [-15,-15,-40] , [15, 15, 40]   ,   0.3],
            "Open_Area" : [ [159, 206, 99] , [43, 132, 206] , [28, 117, 166], [58, 147, 246] ,   0.5],   # No white spaces!
            "River"     : [ [56, 126, 247] , [109, 197, 247], [94, 182, 207], [124, 212, 287],  -1.0],
            "Stream"    : [ [155, 252, 226], [82, 98, 252]  , [67, 83, 212] , [97, 113, 292] ,  -0.8],
            "Swamp"     : [ [222, 129, 67] , [12, 177, 222] , [-3, 162, 182], [27, 192, 262] ,  -0.8],
            "Forest"    : [ [55, 127, 33]  , [53, 187, 127] , [38, 172, 87] , [68, 202, 167] ,  -0.8],
            "Orchard"   : [ [205, 158, 187], [161, 58, 205] , [146, 43, 165], [176, 73, 245] ,  -0.5],
            "Slope"     : [ [             ], [            ] , [            ], [            ] ,  -0.4],
        }
